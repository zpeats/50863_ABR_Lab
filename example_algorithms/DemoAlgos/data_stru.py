...
class TestInput2:
    ...
    def __init__(self, measured_bandwidth: float, buffer_occupancy: BufferOccupancy, available_bitrates: List[List[Union[int, str]]], video_time: float, rebuffering_time: float, chunk: BufferOccupancy, preferred_bitrate: str) -> None:
