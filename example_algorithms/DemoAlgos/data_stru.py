...
class TestInput2:
    ...
    def __init__(self, measured_bandwidth: float, buffer_occupancy: BufferOccupancy, available_bitrates: List[List[Union[int, str]]], video_time: float, rebuffering_time: float, rebuffing_flag: bool, chunk: BufferOccupancy, previous_bitrate: List[Union[int, str]], preferred_bitrate: str) -> None:
